...
## Objective
Create a polished 45-second portfolio video showing the complete local PDF RAG flow and the Python orchestration behind it, with the existing scenes slowed proportionally for easier reading.
